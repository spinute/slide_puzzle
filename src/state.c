...
inline static bool state_left_movable(State state)
{
	return state->i != 0;
}
inline static bool state_down_movable(State state)
{
	return state->j != WIDTH-1;
}
inline static bool state_right_movable(State state)
{
	return state->i != WIDTH-1;
}
inline static bool state_up_movable(State state)
{
	return state->j != 0;
}
