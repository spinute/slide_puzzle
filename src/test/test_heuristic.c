...
{
	state_panel v_list[STATE_WIDTH*STATE_WIDTH] = {1,2,3,4,5,6,7,8,STATE_EMPTY};
...
{
	state_panel v_list[STATE_WIDTH*STATE_WIDTH] = {1,2,3,4,5,6,7,STATE_EMPTY, 8};
	g = state_init(v_list, 0);
...
{
	state_panel v_list[STATE_WIDTH*STATE_WIDTH] = {1,2,3,4,5,6,STATE_EMPTY, 7,8};
	g = state_init(v_list, 0);
...
{
	state_panel v_list[STATE_WIDTH*STATE_WIDTH] = {1,2,3,4,5,6,STATE_EMPTY,8,7};
	g = state_init(v_list, 0);
	TEST_ASSERT_EQUAL(heuristic_manhattan_distance(s, g), 2);
	TEST_ASSERT_EQUAL(heuristic_misplaced_tiles(s, g), 1);
	TEST_ASSERT_EQUAL(heuristic_tiles_out_of_row_col(s, g), 1);
...
{
	state_panel v_list[STATE_WIDTH*STATE_WIDTH] = {1,2,3,4,5,STATE_EMPTY,7,8,6};
	g = state_init(v_list, 0);
	TEST_ASSERT_EQUAL(heuristic_manhattan_distance(s, g), 1);
	TEST_ASSERT_EQUAL(heuristic_misplaced_tiles(s, g), 1);
	TEST_ASSERT_EQUAL(heuristic_tiles_out_of_row_col(s, g), 1);
...
{
	state_panel v_list[STATE_WIDTH*STATE_WIDTH] = {1,2,STATE_EMPTY,4,5,3,7,8,6};
	g = state_init(v_list, 0);
	TEST_ASSERT_EQUAL(heuristic_manhattan_distance(s, g), 2);
	TEST_ASSERT_EQUAL(heuristic_misplaced_tiles(s, g), 2);
	TEST_ASSERT_EQUAL(heuristic_tiles_out_of_row_col(s, g), 2);
...
{
	state_panel v_list[STATE_WIDTH*STATE_WIDTH] = {1,2,STATE_EMPTY,4,5,6,7,8,3};
	g = state_init(v_list, 0);
	TEST_ASSERT_EQUAL(heuristic_manhattan_distance(s, g), 2);
	TEST_ASSERT_EQUAL(heuristic_misplaced_tiles(s, g), 1);
	TEST_ASSERT_EQUAL(heuristic_tiles_out_of_row_col(s, g), 1);
...
{
	state_panel v_list[STATE_WIDTH*STATE_WIDTH] = {1,2,3,4,STATE_EMPTY,6,7,8,5};
	g = state_init(v_list, 0);
	TEST_ASSERT_EQUAL(heuristic_manhattan_distance(s, g), 2);
	TEST_ASSERT_EQUAL(heuristic_misplaced_tiles(s, g), 1);
	TEST_ASSERT_EQUAL(heuristic_tiles_out_of_row_col(s, g), 2);
